...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<?php }?>
			<?php if($row['user_level']==1 || $row['user_level']== 2){ ?>
			<li class="<?php if($_GET['page_layout'] == 'order'){echo 'active';} ?>"><a href="index.php?page_layout=order"><svg class="glyph stroked open folder"><use xlink:href="#stroked-open-folder"/></svg>Quản lý đơn hàng</a></li>
			<?php } ?>
			<?php if($row['user_level']==1){ ?>
